  ...
  <header id="header" class="header fixed-top d-flex align-items-center">
    ...
    <div class="d-flex align-items-center justify-content-between">
      <a href="menu.php" class="logo d-flex align-items-center">
        ...
        <span class="d-none d-lg-block">Acadsuite Net</span>
      </a>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="forms-elements.html">
              <i class="bi bi-circle"></i><span>Archivos básicos</span>
            </a>
          </li>
          <li>
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#charts-nav" data-bs-toggle="collapse" href="#">
          <i class="bi bi-bar-chart"></i><span>Archivos generales</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        ...
        <ul id="icons-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="icons-bootstrap.html">
              <i class="bi bi-circle"></i><span>Cargar tablas CSV</span>
            </a>
          </li>
          <li>
          ...
          <li>
            <a href="icons-boxicons.html">
              <i class="bi bi-circle"></i><span>Rubro Presupuestal</span>
            </a>
          </li>

          <li>
            <a href="icons-boxicons.html">
              <i class="bi bi-circle"></i><span>Validar Dígitos de Verificación</span>
            </a>
          </li>

          <li>
            <a href="icons-boxicons.html">
              <i class="bi bi-circle"></i><span>Plan Inventario</span>
            </a>
          </li>
