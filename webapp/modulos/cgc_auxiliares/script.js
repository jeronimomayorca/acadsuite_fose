...
document.querySelectorAll(".edit-btn").forEach(button => {
    button.addEventListener("click", function () {
        ...
        document.getElementById("editAuxiliar").value = this.dataset.auxiliar;
        document.getElementById("editNaturaleza").value = this.dataset.naturaleza;
        document.getElementById("editIdsubcuenta").value = this.dataset.idsubcuenta;
