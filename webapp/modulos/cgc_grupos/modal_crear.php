        ...
        <div class="modal-content">
            <form id="createForm">
                ...
                <div class="modal-body my-3">
                    ...
                    <input type="text" name="grupo" id="createGrupo" required class="form-control">
                    <label class="mb-2">ID Clase</label>
                    <input type="number" name="idclase" id="createIdclase" required class="form-control">
