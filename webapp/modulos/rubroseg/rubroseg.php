...
<head>
    ...
    <title>Acadsuite FOSE - Gestión de Rubroseg</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Gestión de Rubroseg <?php echo $ano; ?></h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../../menu.php">Inicio</a></li>
                    <li class="breadcrumb-item active">Rubroseg</li>
                </ol>
            </nav>
            <nav>
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        ...
                        <td><?= htmlspecialchars($row['codsifseg']) ?></td>
                        <td class="d-flex justify-content-end">
                            <button type="button" class="btn btn-primary edit-btn mx-1"
                                ...
                                data-codsifseg="<?= htmlspecialchars($row['codsifseg']) ?>"
                                data-bs-toggle="modal" data-bs-target="#editRubrosegModal">Editar</button>
