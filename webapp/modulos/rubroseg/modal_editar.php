<!-- MODAL EDITAR -->
<div class="modal fade" id="editRubrosegModal" tabindex="-1">
        ...
        <div class="modal-content">
            <form id="editForm">
                ...
                <div class="modal-body">
                    ...
                    <label>Código Sifseg</label>
                    <input type="number" name="codsifseg" id="editCodsifseg" required class="form-control">
                </div>
