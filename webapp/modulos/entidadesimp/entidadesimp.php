...
<head>
    ...
    <title>Acadsuite FOSE - Gestión de Entidades Imp</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Gestión de Entidades Imp <?php echo $ano; ?></h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../../menu.php">Inicio</a></li>
                    <li class="breadcrumb-item active">Entidades Imp</li>
                </ol>
            </nav>
            <nav>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-end">
                            <button type="button" class="btn btn-primary edit-btn mx-1"
                                data-id="<?= $row['identidad'] ?>"
                                data-entidad="<?= htmlspecialchars($row['entidad']) ?>"
                                data-bs-toggle="modal" data-bs-target="#editEntidadModal">Editar</button>
                            <button type="button" class="btn btn-danger delete-btn mx-1" data-id="<?= $row['identidad'] ?>">Eliminar</button>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
