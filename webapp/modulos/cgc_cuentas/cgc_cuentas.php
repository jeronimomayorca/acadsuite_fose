...
<head>
    ...
    <title>Acadsuite FOSE - Gestión de CGC Cuentas</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Gestión de CGC Cuentas <?php echo $ano; ?></h1>
            <nav>
                <ol class="breadcrumb">
                    <li class="breadcrumb-item"><a href="../../menu.php">Inicio</a></li>
                    <li class="breadcrumb-item active">CGC Cuentas</li>
                </ol>
            </nav>
            <nav>
                    ...
                    <tr>
                        ...
                        <td class="d-flex justify-content-end">
                            <button type="button" class="btn btn-primary edit-btn mx-1"
                                ...
                                data-cuenta="<?= htmlspecialchars($row['cuenta']) ?>"
                                data-idgrupo="<?= htmlspecialchars($row['idgrupo']) ?>"
