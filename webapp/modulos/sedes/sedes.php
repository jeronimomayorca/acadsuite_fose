...
<head>
    ...
    <title>Acadsuite FOSE - Gestión de Sedes</title>
...
<body>
    ...
    <main id="main" class="main">
        <div class="pagetitle">
            <h1>Gestión de Sedes <?php echo $ano; ?></h1>
            <nav>
                <ol class="breadcrumb">
        ...
        <table class="table">
            ...
            <tbody>
                <?php while ($row = $result->fetch_assoc()): ?>
                    <tr>
                        <td><?= htmlspecialchars($row['idsede']) ?></td>
                        ...
                        <td class="d-flex justify-content-end">
                            <button type="button" class="btn btn-primary edit-btn mx-1"
                                ...
                                data-bs-toggle="modal" data-bs-target="#editSedeModal">Editar</button>
                            <button type="button" class="btn btn-danger delete-btn mx-1" data-id="<?= $row['idsede'] ?>">Eliminar</button>
                        </td>
                    </tr>
                <?php endwhile; ?>
            </tbody>
