...
setlocale(LC_ALL, "es_LA");
$sql = "SELECT ano,semestre FROM actual where id_actual=1";
    ...
    <nav class="header-nav ms-auto">
      <ul class="d-flex align-items-center">
        ...
        <li class="nav-item hidden-sm-down">
          <select id="ano_parametro" name="ano_parametro" class="form-select" onchange="anoparametro();">
            <option style='color:red;' value='<?php echo $ano_parametro; ?>'>&nbsp;&nbsp;<?php echo $ano_parametro; ?>&nbsp;&nbsp;</option>
            <?php
            while ($electo = $abre_parametros->fetch_array()) {
              $ano_parametro = $electo['ano_parametro'];
            ?>
              <option value="<?php echo $ano_parametro; ?>">&nbsp;&nbsp;<?php echo $ano_parametro; ?>&nbsp;&nbsp;</option>
            <?php
            }
            ?>
          </select>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="forms-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="proyectos/movimientos.php">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="informes/basicos.php">
              <i class="bi bi-circle"></i><span>Básicos</span>
            </a>
          </li>
          <li>
            <a href="informes/movimientos.php">
              <i class="bi bi-circle"></i><span>Movimientos</span>
            </a>
          </li>
          <li>
            <a href="informes/cuipo.php">
      ...
      <li class="nav-item">
        ...
        <ul id="charts-nav" class="nav-content collapse" data-bs-parent="#sidebar-nav">
          <li>
            <a href="catalogos/catalogos.php">
      ...
      <li class="nav-item">
        <a class="nav-link collapsed" data-bs-target="#areaspoai-nav" data-bs-toggle="collapse" href="#">
          <i class="ri ri-settings-5-line"></i><span>Areaspoai</span><i class="bi bi-chevron-down ms-auto"></i>
        </a>
        <ul id="areaspoai-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          <li>
            <a href="modulos/areaspoai/areaspoai.php">
              <i class="bi bi-circle"></i><span>Areaspoai</span>
            </a>
          </li>
      ...
      <br><br><br><br><br>
      <li class="nav-item">
        <center><span><img width="70%" heigth="70%" class="img-thumbnail" src="../images/logoxarasoft.jpg"></span></center>
      </li>
            ...
            <div class="card-body pb-0">
              ...
              <div class="news">
                ...
                <div class="post-item clearfix">
                  ...
                  <h4><a href="#">Laborum corporis quo dara FOSE para</a></h4>
