...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Gestión Financiera / Amortizaciones <?php echo $ano?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../../webapp/menu.php">Inicio</a></li>
          <li class="breadcrumb-item active">Amortizaciones</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->


    <section class="section amortizaciones">
      <div class="row">
        <div class="col-lg-12">
