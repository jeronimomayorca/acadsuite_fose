...
<body>
    ...
    <ul class="sidebar-nav" id="sidebar-nav">
      ...
      <li class="nav-item">
        ...
        <ul id="tables-nav" class="nav-content collapse " data-bs-parent="#sidebar-nav">
          ...
          <li>
            <a href="../../webapp/informes/cuipo.php">
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Gestión Recursos Físicos / Contabilidad <?php echo $ano?></h1>
      <nav>
        <ol class="breadcrumb">
    ...
    <section class="section contabilidad">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Contablidad</h5>

              <ul class="nav nav-tabs d-flex" id="myTabjustified" role="tablist">
                <li class="nav-item flex-fill" role="configuracion">
                  <button class="nav-link w-100 active" id="configuracion-tab" data-bs-toggle="tab" data-bs-target="#configuracion-justified" type="button" role="tab" aria-controls="configuracion" aria-selected="false">Configuración</button>
                </li>

                <li class="nav-item flex-fill" role="interfase">
                  <button class="nav-link w-100" id="interfase-tab" data-bs-toggle="tab" data-bs-target="#interfase-justified" type="button" role="tab" aria-controls="interfase" aria-selected="false">Interfase Depreciación</button>
                </li>
              </ul>


              <div class="tab-content pt-2" id="myTabjustifiedContent">
                <div class="tab-pane fade show active" id="configuracion-justified" role="tabpanel" aria-labelledby="configuracion-tab">
                  1
                </div>
                <div class="tab-pane fade" id="interfase-justified" role="tabpanel" aria-labelledby="interfase-tab">
                  2
                </div>
