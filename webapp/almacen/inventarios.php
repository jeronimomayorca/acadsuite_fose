...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Gestión Recursos Físicos / Inventarios <?php echo $ano?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../../webapp/menu.php">Inicio</a></li>
          <li class="breadcrumb-item active">Almacén e inventarios</li>
        </ol>
      </nav>
      ...
      <ul class="nav nav-pills">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#" style="color:black;" >Listado Plan de Inventario</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Listado Plan Inventario Excel</a></li>
          </ul>
        </li>
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#" style="color:black;" >Auxiliares Movimiento Almacén</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Auxiliares Movimiento por Tipo</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Auxiliares Movimiento por Dependencia</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Auxiliares Movimiento por Proyecto</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Códigos de Artículos</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Seguimiento Placas</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Informe Movimiento Artículo</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Informe Salida Comprobante</a></li>
        </ul>
        ...
        <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#" style="color:black;" >Listados de Inventario</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Informe de Depreciación Almacén</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Existencias de Inventario</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Informe Consolidado Almacén</a></li>
        </ul>
    ...
    <section class="section inventarios">
      <div class="row">
        <div class="col-lg-12">
          ...
          <div class="card">
            <div class="card-body">
              ...
              <ul class="nav nav-tabs" id="myTabjustified" role="tablist">
                <li class="nav-item" role="plancuentas">
                  <button class="nav-link active" id="plancuentas-tab" data-bs-toggle="tab" data-bs-target="#plancuentas-justified" type="button" role="tab" aria-controls="plancuentas" aria-selected="false">Plan de Inventario</button>
                </li>

                <li class="nav-item" role="editararticulo">
                  <button class="nav-link" id="-tab" data-bs-toggle="tab" data-bs-target="#editararticulo-justified" type="button" role="tab" aria-controls="editararticulo" aria-selected="false">Detalle de Artículos</button>
                </li>

                <li class="nav-item" role="configuracion">
                  <button class="nav-link" id="configuracion-tab" data-bs-toggle="tab" data-bs-target="#configuracion-justified" type="button" role="tab" aria-controls="configuracion" aria-selected="false">Configuración Almacén</button>
                </li>
              ...
              <div class="tab-content pt-2" id="myTabjustifiedContent">
                <div class="tab-pane fade show active" id="plancuentas-justified" role="tabpanel" aria-labelledby="plancuentas-tab">
                  1
                </div>
                <div class="tab-pane fade" id="editararticulo-justified" role="tabpanel" aria-labelledby="editararticulo-tab">
                  2
                </div>
                <div class="tab-pane fade" id="configuracion-justified" role="tabpanel" aria-labelledby="configuracion-tab">
                  3
                </div>
