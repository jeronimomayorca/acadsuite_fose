...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Gestión Financiera / Traslados Centros de Costo <?php echo $ano?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../../webapp/menu.php">Inicio</a></li>
          <li class="breadcrumb-item active">Traslado Centros de Costo</li>
        </ol>
      </nav>
    </div><!-- End Page Title -->


    <section class="section costos">
      <div class="row">
        <div class="col-lg-12">
            ...
            <div class="card-body">
              ...
              <ul class="nav nav-tabs" id="myTabjustified" role="tablist">
                <li class="nav-item" role="configuracion">
                  <button class="nav-link active" id="configuracion-tab" data-bs-toggle="tab" data-bs-target="#configuracion-justified" type="button" role="tab" aria-controls="configuracion" aria-selected="false">Configuración</button>
                </li>

                <li class="nav-item" role="generacion">
                  <button class="nav-link" id="generacion-tab" data-bs-toggle="tab" data-bs-target="#generacion-justified" type="button" role="tab" aria-controls="generacion" aria-selected="false">Generar Traslados</button>
                </li>                       
              </ul>
              ...
              <div class="tab-content pt-2" id="myTabjustifiedContent">
                ...
                <div class="tab-pane fade" id="generacion-justified" role="tabpanel" aria-labelledby="generacion-tab">
                  2
                </div>
