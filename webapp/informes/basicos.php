...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Informes / Informes básicos <?php echo $ano?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../../webapp/menu.php">Inicio</a></li>
          <li class="breadcrumb-item active">Básicos</li>
        </ol>
      </nav>
      ...
      <ul class="nav nav-pills">
        <li class="nav-item dropdown">
          ...
          <ul class="dropdown-menu">
            <li><a class="dropdown-item" href="#" style="color:black;" >Informe Homologaciones</a></li>
            <li><a class="dropdown-item" href="#" style="color:black;" >Informe Inconsistencias Homologaciones</a></li>
          </ul>
        </li>
    ...
    <section class="section informesbasicos">
        <div class="row">
          <div class="col-lg-12">

            <div class="card">
              <div class="card-body">
                <h5 class="card-title">Informes básicos</h5>

                <ul class="nav nav-tabs" id="myTabjustified" role="tablist">

                  <li class="nav-item" role="clase">
                    <button class="nav-link active" id="clase-tab" data-bs-toggle="tab" data-bs-target="#clase-justified" type="button" role="tab" aria-controls="clase" aria-selected="false">Clase</button>
                  </li>

                  <li class="nav-item" role="periodicidad">
                    <button class="nav-link " id="periodicidad-tab" data-bs-toggle="tab" data-bs-target="#periodicidad-justified" type="button" role="tab" aria-controls="periodicidad" aria-selected="false">Periodicidad</button>
                  </li>

                  <li class="nav-item" role="tipoinforme">
                    <button class="nav-link" id="tipoinforme-tab" data-bs-toggle="tab" data-bs-target="#tipoinforme-justified" type="button" role="tab" aria-controls="tipoinforme" aria-selected="false">Tipo Informe</button>
                  </li>
                ...
                <div class="tab-content pt-2" id="myTabjustifiedContent">
                  <div class="tab-pane fade show active" id="clase-justified" role="tabpanel" aria-labelledby="clase-tab">
                    1
                  </div>
                  <div class="tab-pane fade" id="periodicidad-justified" role="tabpanel" aria-labelledby="periodicidad-tab">
                    2
                  </div>
                  <div class="tab-pane fade" id="tipoinforme-justified" role="tabpanel" aria-labelledby="tipoinforme-tab">
                    3
                  </div>
