...
<body>
  ...
  <main id="main" class="main">
    ...
    <div class="pagetitle">
      <h1>Informes / Informes de Movimientos <?php echo $ano?></h1>
      <nav>
        <ol class="breadcrumb">
          <li class="breadcrumb-item"><a href="../../webapp/menu.php">Inicio</a></li>
          <li class="breadcrumb-item active">Informe Movimientos</li>
        </ol>
      </nav>
    ...
    <section class="section informemovimientos">
      <div class="row">
        <div class="col-lg-12">

          <div class="card">
            <div class="card-body">
              <h5 class="card-title">Informes de Movimientos</h5>

              <ul class="nav nav-tabs" id="myTabjustified" role="tablist">

                  <li class="nav-item" role="homologaciones">
                    <button class="nav-link active" id="homologaciones-tab" data-bs-toggle="tab" data-bs-target="#homologaciones-justified" type="button" role="tab" aria-controls="homologaciones" aria-selected="false">Homologaciones</button>
                  </li>

                  <li class="nav-item" role="generar">
                    <button class="nav-link " id="generar-tab" data-bs-toggle="tab" data-bs-target="#generar-justified" type="button" role="tab" aria-controls="generar" aria-selected="false">Generar Informe</button>
                  </li>|
              </ul>


              <div class="tab-content pt-2" id="myTabjustifiedContent">
                <div class="tab-pane fade show active" id="homologaciones-justified" role="tabpanel" aria-labelledby="homologaciones-tab">
                  1
                </div>
                <div class="tab-pane fade" id="generar-justified" role="tabpanel" aria-labelledby="generar-tab">
                  2
                </div>
                <div class="tab-pane fade" id="informessia-justified" role="tabpanel" aria-labelledby="informessia-tab">
                  3
                </div>
